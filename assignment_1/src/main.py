...
print('*'*50 + ' simple Linear Regression ' + '*'*50)
...
print('*'*50 + ' Polynomial Regression ' + '*'*50)
...
print('*'*50 + ' Multiple Linear Regression with regularization ' + '*'*50)
...
#The following is just to try out SVR
...
#predict for train to get training error 
